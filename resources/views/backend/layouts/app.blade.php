...
<div class="w-full min-h-screen flex flex-col">
      ...
      <div class="min-h-screen lg:flex" x-data="{open: false}">
        ...
        >
          ...
          <div
            class="flex flex-col justify-start items-start w-full space-y-4 text-black mt-10"
          >
            <div
            ...
            <div x-data="{openDrop:false}" class="w-full">
              ...
              >
                <div class="flex">
                  ...
                  <span class="ml-3 font-light text-[15px]"
                    >Manajemen Admin</span
                  >
                </div>
              ...
              <div
                class="text-left text-sm w-4/5 mx-auto"
                x-show="openDrop"
                @click.outside="openDrop = false"
              >
                <h1 class="cursor-pointer p-2 hover:bg-blue-200 rounded-md">
                  <a href="{{route('b.manage.role.index')}}">Manajemen Role</a>
                </h1>
                <h1 class="cursor-pointer p-2 hover:bg-blue-200 rounded-md">
                  <a href="{{route('b.manage.permission.index')}}"
                    >Manajemen Permission</a
                  >
                </h1>
                <h1 class="cursor-pointer p-2 hover:bg-blue-200 rounded-md">
        ...
        <div class="relative z-0 lg:flex-grow">
          ...
          <header class="flex bg-white border-b text-black items-center px-2">
            ...
            <div class="w-full max-w-full">
              <div
                class="h-[60px] border-b w-full flex items-center justify-end"
              >
                <div
                  class="bg-red-500 rounded-md px-5 text-white items-center flex cursor-pointer mr-2"
                >
