...
@section('content-admin')
    ...
    <div class="flex flex-1 items-center justify-center">
        <div class="w-full mx-20 my-20">
            ...
            <form action="{{ route('backend.sekolah.edit.process', $sekolah->id) }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                    <label for="name" class="text-sm font-medium text-gray-900 block mb-2">Name sekolah</label>
                    <input type="text" value="{{ $sekolah->name }}" id="name" name="name"
