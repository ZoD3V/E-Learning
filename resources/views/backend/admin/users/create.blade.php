...
@section('content-admin')
    ...
    <div class="flex flex-1 items-center justify-center">
        <div class="w-full mx-20 my-20">
            ...
            <form action="{{ route('b.manage.user.create.process') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                    <label for="role" class="text-sm font-medium text-gray-900 block mb-2">Name User</label>
