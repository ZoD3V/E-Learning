...
@section('content-admin')
    ...
    <div class="flex flex-1 items-center justify-center">
        <div class="w-full mx-20 my-20">
            ...
            <form action="{{ route('backend.siswa.edit.process', $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <select id="kelas_id" name="kelas_id"
                        ...
                        @foreach ($kelas as $data)
                            <option value="{{ $data->id }}" @selected($data->id == $user->kelas_id)>{{ $data->name }} -
