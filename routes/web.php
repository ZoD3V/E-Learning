...
// SISWA
Route::get('/siswa/home', [SiswaHomeController::class, 'index'])->name('frontend.siswa.index');
...
Route::post('/backend/mapel/process/{id?}', [MapelController::class, 'edit_process'])->name('backend.mapel.edit.process');
